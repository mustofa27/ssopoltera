            ...
            <div class="grid mb-16">
                ...
                <div>
                    ...
                    <div class="user-picker js-user-picker" data-search-url="{{ route('users.search') }}">
                        <input class="input js-user-search" id="head_user_search" type="text" name="head_user_query" value="{{ old('head_user_query', $supportUnit->head ? $supportUnit->head->name . ' (' . $supportUnit->head->email . ')' : '') }}" placeholder="Type name or email to search">
                        <input class="js-user-id" id="head_user_id" type="hidden" name="head_user_id" value="{{ old('head_user_id', $supportUnit->head_user_id) }}">
